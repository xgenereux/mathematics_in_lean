...
/- Let's look at the universal quantifier and implication -/
...
/- @ prevents lean from inserting placeholders here (hover)-/
lemma test1  {f : ℝ → ℝ} (h : Monotone f) : ∀ {a b}, a ≤ b → f a ≤ f b :=
  @h
